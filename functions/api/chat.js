...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const geminiRequestBody = {
      ...
      systemInstruction: {
        parts: [{ text: deepResearch
          ? "Tum Nova ho, ek research assistant. User ke sawaal ka jawab dene ke liye Google Search ka use karo taaki current, sahi jaankari mile. Jawab Hinglish mein, thoda detailed lekin clear do."
          : "Tum Nova ho, ek friendly AI assistant jo Hinglish mein natural, chhote jawab deta hai." }]
      }
    };
    if (deepResearch) {
      geminiRequestBody.tools = [{ google_search: {} }];
    }
